package com.monsterWords.view.skins;
...
public class MySkin {
	...
	public static Skin getHugeRedButtonSkin() {
		...
		BitmapFont bitmap = new BitmapFont(Gdx.files.internal("fonts/cracked-red-94.fnt"), false);
		skin.add("default", bitmap);
	...
	public static Skin getBigRedButtonSkin() {
		...
		BitmapFont bitmap = new BitmapFont(Gdx.files.internal("fonts/cracked-red-72.fnt"), false);
		skin.add("default", bitmap);
	...
	public static Skin getMediumRedButtonSkin() {
		...
		BitmapFont bitmap = new BitmapFont(Gdx.files.internal("fonts/cracked-red-50.fnt"), false);
		skin.add("default", bitmap);
	...
	public static Skin getSmallRedButtonSkin() {
		...
		BitmapFont bitmap = new BitmapFont(Gdx.files.internal("fonts/cracked-red-32.fnt"), false);
		skin.add("default", bitmap);
